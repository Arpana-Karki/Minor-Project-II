...
<body>
    <header>
        <div class="container">
            <nav>
                <div class="logo">
                    <span class="logo-text">SalonSpear</span>
                </div>
                <ul class="nav-links">
                    <li><a href="home.php">Home</a></li>
                    <li><a href="login.php">Login/Register</a></li>
                    <li><a href="#contact" id="contact-btn">Contact Us</a></li>
                </ul>
            </nav>
        </div>
    </header>
        ...
        <div class="container">
            ...
            if (!empty($availableServices)) {
                ...
                foreach ($availableServices as $service) {
                    ...
                    // Book now button
                    echo '<button class="book-now-btn" onclick="checkLoginAndBook(' . $service['id'] . ')">Book Now</button>';
                    echo '</div>';
                    echo '</div>';
                }
                echo '</div>';
    ...
    <script>
        function checkLoginAndBook(serviceId) {
            <?php if (!isset($_SESSION['username'])): ?>
                // If the user is not logged in
                if (confirm('You need to login to book services and purchase products. Do you want to login?')) {
                    window.location.href = 'login.php'; // Redirect to login page
                } else {
                    window.location.href = 'index.php'; // Stay on the current page
                }
            <?php else: ?>
